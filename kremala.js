...
function paixnidi(){ 
    document.body.style.backgroundImage = "url('2kremala0.jpg')";  
...
function topo8ethsh(){
    ...
    document.getElementById("box").style.top = (h*0.35)+"px";
    document.getElementById("box").style.left= (y+x*0.03)+"px";
    document.getElementById("box").style.fontSize= (x/16)+"px";
}
