...
"ΕΜΜΟΝΗ",
"ΕΝΑ ΗΣΥΧΟ ΜΕΡΟΣ ",
"ΕΝΑ ΚΟΡΙΤΣΙ ΓΥΡΙΖΕΙ ΣΠΙΤΙ ΜΟΝΟ ΤΟΥ ΤΗ ΝΥΧΤΑ",
...
"ΟΙ ΣΥΝΕΝΟΧΟΙ",
"ΟΙ ΤΕΣΣΕΡΙΣ ΚΑΒΑΛΑΡΗΔΕΣ ΤΗΣ ΑΠΟΚΑΛΥΨΗΣ",
...
"ΣΙΩΠΗΛΟΣ ΔΟΛΟΦΟΝΟΣ",
"ΣΙΩΠΗΛΟΣ ΕΦΙΑΛΤΗΣ",
"ΣΚΕΦΤΗΚΑΤΕ ΠΟΤΕ ΝΑ ΣΚΟΤΩΣΕΤΕ ΤΟΝ ΚΑΘΗΓΗΤΗ ΣΑΣ",
"ΣΚΛΗΡΟΙ ΑΝΤΡΕΣ",
"ΣΚΛΗΡΟΙ ΣΑΝ ΜΕΤΑΛΛΟ",
"ΣΚΟΤΕΙΝΗ ΑΝΑΜΝΗΣΗ",
"ΣΚΟΤΕΙΝΗ ΔΥΝΑΜΗ",
...
function paixnidi(){ 
    document.body.style.backgroundImage = "url('kremala0.jpg')";  
...
function uparxei(g){
    ...
    if(tainia.includes(g)){
        ...
        if(!krummenhtainia.includes("_")){
            document.getElementById("grammata").innerHTML = "ΚΕΡΔΙΣΕΣ";
            telospaixnidiou();
        }
    }else{
        ...
        if(counterla8osgrammata == 6){
            ...
            document.getElementById("grammata").innerHTML = "ΕΧΑΣΕΣ";
            telospaixnidiou();
        }
    }  
}

function telospaixnidiou(){
...
//function topo8ethsh2(){
    //document.body.style.fontSize="24px";
    //document.getElementById("tainia").style.fontWeight = "bold";
    //document.getElementById("tainia").style.letterSpacing="3px";
    //document.getElementById("tainia").style.wordSpacing="8px";
    //document.getElementById("tainia").style.backgroundColor="red";
    //document.getElementById("tainia").style.opacity="0.5";
    //document.getElementById("tainia").innerHTML= h;
    //document.getElementById("grammata").style.padding= "15px";
    //document.getElementById("grammata").style.margin= "40px";
...
function topo8ethsh(){
    ...
    for ( var i = 0; i < ab.length; i++ ){
        var gr = ab.charAt(i);
        document.getElementById(gr).style.width=(x/10)+"px";
        document.getElementById(gr).style.height=(x/10)+"px";
    }   
    document.getElementById("grammata").style.bottom = (h*0.0000000001)+"px";
    document.getElementById("grammata").style.left= (y+(x-(x*0.8444))/2)+"px";


    //var uyostainias = h*0.72 ; 
    //document.getElementById("tainia").style.marginTop= uyostainias+"px";
}
